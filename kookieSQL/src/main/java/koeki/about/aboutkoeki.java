...
public class aboutkoeki extends ListenerAdapter {
    ...
    private static String pfpurl = "https://i.imgur.com/fZaiKRc.png";
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent event) {
        ...
        if (content.toLowerCase().startsWith("k!aboutkoeki")) {
            ...
            ebP1.setColor(Color.decode(color));
    ...
    public void onGuildMessageReactionAdd(GuildMessageReactionAddEvent event) {
        ...
        ebP3.setColor(Color.decode(color));
        ...
        ebP4.setColor(Color.decode(color));
        ...
        for(AK0attributes a : AK0attributesList){
            if(event.getGuild().getIdLong() == a.getGuildID()){
